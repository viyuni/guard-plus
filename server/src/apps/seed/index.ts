...
async function findPointType(targetDb: DbClient, name: string) {
...
async function ensureRewardRule(targetDb: DbClient, input: InsertRewardRule) {
...
async function ensurePointConversionRule(targetDb: DbClient, input: InsertPointConversionRule) {
...
async function seedRewardRules(targetDb: DbClient, pointTypeMap: SeedRewardPointTypeMap) {
...
async function seedPointConversionRules(targetDb: DbClient, pointTypeMap: SeedRewardPointTypeMap) {
...
export async function seedV2(targetDb: DbClient) {
